...
if __name__ == '__main__':
    ...
    with tf.Session() as sess:
        X = tf.placeholder(dtype=tf.float32, shape=[None, 160, 160, 3])
        inception_resnet_v1(X)
        f=tf.summary.FileWriter('/home/zhangxk/mysite/recognition_facenet/cv',sess.graph)
        f.close()