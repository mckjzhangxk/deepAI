...
public class TFJob {
    ...
    static class MyMapper extends Mapper<Object,Text,Weibo,IntWritable>{
    ...
    static class MyReduce extends Reducer<Weibo,IntWritable,Text,IntWritable> {
    ...
    static class MyGroupComparator extends WritableComparator{
