...
Image::Image(const std::shared_ptr<IoStrategy>& io_strategy) : io_strategy_(io_strategy) {
}
Image::Image(int rows, int cols, const std::shared_ptr<IoStrategy>& io_strategy) : rows_(rows), cols_(cols), io_strategy_(io_strategy) {
...
void Image::set_io_strategy(const std::shared_ptr<IoStrategy>& io) {
    io_strategy_ = io;
}
