...
const openOrCloseClick=(flag)=>{
    //打开关闭 视频和音频的 [事件回调函数]
    //flag video|audio
    var enabled=flag=='video'?localStream.getVideoTracks()[0].enabled:localStream.getAudioTracks()[0].enabled
    if(enabled){
        setClose(flag)
    }else{
        setOpen(flag)
        ...
        function setClose(flag){
            ...
            */
            if(flag=='video'){
                ...
                document.querySelector('.openOrCloseVideo').innerHTML='<i class="fas fa-video"></i>\
                <span>开启视频</span>'
            }else{
                localStream.getAudioTracks()[0].enabled=false
                document.querySelector('.openOrCloseAudio').innerHTML='<i class="fa fa-microphone" aria-hidden="true"></i>\
            <span>语音</span>'
            }
        }
        ...
        function setOpen(flag){
            ...
            */
            ...
            if(flag=='video'){
                ...
                document.querySelector('.openOrCloseVideo').innerHTML='<i class="fas fa-video-slash stop"></i>\
                <span class="stop">关闭视频</span>'
            }else{
                localStream.getAudioTracks()[0].enabled=true
                document.querySelector('.openOrCloseAudio').innerHTML=' <i class="fas fa-microphone-slash stop"></i>\
