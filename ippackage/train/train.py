        ...
        with tf.summary.FileWriter(hparam.log_dir,trainModel.graph) as logfs:
            ...
            for step in range(outter_steps):
                try:
                    ...
                    sess.run(model.transfer_initState_op)
                except tf.errors.OutOfRangeError:
...
hparam = tf.contrib.training.HParams(
    ...
    train_datafile='/home/zhangxk/projects/deepAI/ippackage/data/data',
    eval_datafile='/home/zhangxk/projects/deepAI/ippackage/data/data',
