...
class DataConf():
    ...
    target_path = '/home/zhangxk/AIProject/ippack/3-5'
    #临时输出的数据文件
    ...
    BASE_NUM=5000
    TrainFile='/home/zhangxk/AIProject/ippack/output/train.txt'

    DevFile = '/home/zhangxk/AIProject/ippack/output/dev.txt'
